...
public class ListBedActivity extends AppCompatActivity implements DeleteBedDialog.BedDialogListener {
    ...
    public void onYesClicked() {
        Toast.makeText(ListBedActivity.this, "Deleted", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(ListBedActivity.this, HomeActivity.class);
        startActivity(intent);
    }
    ...
    public void onNoClicked() {
        Toast.makeText(ListBedActivity.this, "Canceled", Toast.LENGTH_SHORT).show();
